...
public class MainActivity extends AppCompatActivity {
    ...
    private void showAboutDialog() {
        String versionName = BuildConfig.VERSION_NAME; // Obtém a versão do aplicativo

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(R.string.menu_about_title);
        builder.setMessage(getString(R.string.about_message, versionName)); // Exibe a versão no corpo da mensagem
